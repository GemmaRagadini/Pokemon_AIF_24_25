...
from vgc.behaviour.BattlePolicies import RandomPlayer, MCTS_MR, MCTS_MS,TunedTreeTraversal,Minimax, MyMinimax, MyMonteCarlo, MyMinimaxWithAlphaBeta, MyMinimaxWithAlphaBetaKiller,MyMinimaxWithAlphaBetaSortedKiller,MyMinimaxWithAlphaBetaKillertransposition,Bot4BattlePolicy,AggressiveMinimaxWithSwitchAndKiller
...
class MyCompetitor0(Competitor): 
    ...
    def __init__(self, name: str = "My Example"):
        self._name = name
        self._battle_policy = AggressiveMinimaxWithSwitchAndKiller()
