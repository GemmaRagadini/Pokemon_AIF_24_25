...
def main():
    ...
    end_time = time.time()
    print(f"Dopo {n_epochs} competizioni con team diversi:")
    print(f"Player 0  con {cm1.competitor.battle_policy.name} ha vinto: {wins_player0}")
    print(f"Player 1 con {cm2.competitor.battle_policy.name} ha vinto: {wins_player1}")    
